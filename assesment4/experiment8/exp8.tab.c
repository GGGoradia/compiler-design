...
static const char *const yytname[] =
{
  ...
  "EOL", "$accept", "input", "line", "expr", "term", "factor", YY_NULLPTR
};
...
#line 1173 "exp8.tab.c"
    break;

  case 6: /* expr: expr PLUS term  */
#line 58 "exp8.y"
                         { (yyval.node) = createOperatorNode("+", (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1179 "exp8.tab.c"
    break;

  case 7: /* expr: expr MINUS term  */
#line 59 "exp8.y"
                          { (yyval.node) = createOperatorNode("-", (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1185 "exp8.tab.c"
    break;

  case 8: /* expr: term  */
#line 60 "exp8.y"
                         { (yyval.node) = (yyvsp[0].node); }
#line 1191 "exp8.tab.c"
    break;

  case 9: /* term: term MULTIPLY factor  */
#line 63 "exp8.y"
                             { (yyval.node) = createOperatorNode("*", (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1197 "exp8.tab.c"
    break;

  case 10: /* term: term DIVIDE factor  */
#line 64 "exp8.y"
                             { (yyval.node) = createOperatorNode("/", (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1203 "exp8.tab.c"
    break;

  case 11: /* term: factor  */
#line 65 "exp8.y"
                             { (yyval.node) = (yyvsp[0].node); }
#line 1209 "exp8.tab.c"
    break;

  case 12: /* factor: NUMBER  */
#line 68 "exp8.y"
                          { (yyval.node) = createNumberNode((yyvsp[0].value)); }
#line 1215 "exp8.tab.c"
    break;

  case 13: /* factor: IDENTIFIER  */
#line 69 "exp8.y"
                          { (yyval.node) = createIdentifierNode((yyvsp[0].id)); }
#line 1221 "exp8.tab.c"
    break;

  case 14: /* factor: LPAREN expr RPAREN  */
#line 70 "exp8.y"
                             { (yyval.node) = (yyvsp[-1].node); }
#line 1227 "exp8.tab.c"
    break;

  case 15: /* factor: factor POWER factor  */
#line 71 "exp8.y"
                              { (yyval.node) = createOperatorNode("^", (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1233 "exp8.tab.c"
    break;


#line 1237 "exp8.tab.c"
